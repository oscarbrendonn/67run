...
export class Player {
  ...
  async startBike() {
    ...
    // Combined Mav-on-bike GLB (Mav already posed sitting on bike, single
    // mesh). Hide the running GLB Mav while the combined is shown so we
    // don't render two Mavs at once.
